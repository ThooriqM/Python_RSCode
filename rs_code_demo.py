...
Original file is located at
    https://colab.research.google.com/drive/1jYT8V49bh-VfstfhJAwr7MGjORopYA9H
"""
...
def rs_correct_msg(msg_in, nsym, erase_pos=None):
    ...
    return msg_out[:-nsym], msg_out[-nsym:], err_pos # also return the corrected ecc block so that the user can check()